...
echo "<h3>Contact Information</h3>
        <p><i style='font-size:24px' class='material-icons'>home</i> No.15, Lorong IM12/3, Taman Astana Permai,<br>
        &nbsp &nbsp &nbsp 25200 Kuantan,Pahang.</p>
        <p><i style='font-size:24px' class='material-icons'>call</i> +6014 323 9792</p>
        <p><a href='mailto:https://drbrownieshq@gmail.com/html/'><i style='font-size:24px' class='material-icons'>email</i> drbrownieshq@gmail.com</a></p>";				
?>
</div>
